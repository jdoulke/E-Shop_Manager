    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(client_name.getText().toString().isEmpty() && client.getName() != null)
                    name = client.getName();
                else
                    name = client_name.getText().toString();
                if(client_lastname.getText().toString().isEmpty() && client.getLastname() != null)
                    lastname = client.getLastname();
                else
                    lastname = client_lastname.getText().toString();
                long phone_number = 0;
                try {
                    if(client_phone_number.getText().toString().isEmpty())
                ...
                String date = "";
                try {
                    if(client_date.getText().toString().isEmpty())
                        date = client.getRegisteration_date();
                    else {
